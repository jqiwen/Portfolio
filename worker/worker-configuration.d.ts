/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6fe0ce7174cd7a735baec360a54ee272)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 
interface __BaseEnv_Env {
	CONTACT_FROM_EMAIL: "contact@jqiwen.com";
	CONTACT_TO_EMAIL: "kyraoaij@gmail.com";
	RESEND_API_KEY: string;
	CONTACT_RATE_LIMITER: DurableObjectNamespace<import("./src/index").ContactRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ContactRateLimiter";
	}
